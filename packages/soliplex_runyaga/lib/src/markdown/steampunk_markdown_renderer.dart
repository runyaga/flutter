...
/// Boiler Room markdown renderer with industrial theming.
class SteampunkMarkdownRenderer extends MarkdownRenderer {
  const SteampunkMarkdownRenderer({
    required super.data,
    super.onLinkTap,
    super.onImageTap,
  ...
  Widget build(BuildContext context) {
    ...
    final monoStyle = BoilerTypography.jetBrainsMono(fontSize: 13);
    ...
    return MarkdownBody(
      ...
      builders: {
        ...
        'pre': CodeBlockBuilder(
          preferredStyle: monoStyle.copyWith(fontSize: 13),
        ),
