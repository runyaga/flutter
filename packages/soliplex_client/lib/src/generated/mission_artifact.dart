...
MissionArtifact missionArtifactFromJson(String str) => MissionArtifact.fromJson(json.decode(str));

String missionArtifactToJson(MissionArtifact data) => json.encode(data.toJson());
