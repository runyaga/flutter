...
MissionState missionStateFromJson(String str) =>
    MissionState.fromJson(json.decode(str));
...
class MissionState {
  ...
  factory MissionState.fromJson(Map<String, dynamic> json) => MissionState(
        artifacts: List<MissionArtifact>.from(
            json["artifacts"].map((x) => MissionArtifact.fromJson(x))),
        createdAt: DateTime.parse(json["created_at"]),
        goal: json["goal"],
        missionId: json["mission_id"],
        pendingApprovals: List<ApprovalRequest>.from(
            json["pending_approvals"].map((x) => ApprovalRequest.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "pending_approvals":
            List<dynamic>.from(pendingApprovals.map((x) => x.toJson())),
